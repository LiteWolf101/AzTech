...
public class InfoPage extends Screen {
    private InfoPage.InfoPanel loreInfo;
    ...
    public InfoPage(ITextComponent title, ITextComponent lore_translation) {
        super(title);
    ...
    @Override
    public void onClose() {
        this.minecraft.player.world.playSound(this.minecraft.player, this.minecraft.player.getPosition(), SoundEvents.ITEM_BOOK_PAGE_TURN, SoundCategory.MASTER, 1, 1);
        this.minecraft.displayGuiScreen(new AzotomeScreen());
    }
    ...
    class InfoPanel extends ScrollPanel {
        ...
        private List<ITextComponent> resizeContent(List<String> lines) {
            ...
            for (String line : lines) {
                ...
                if (maxTextLength >= 0) {
                    ret.addAll(RenderComponentsUtil.splitText(chat, maxTextLength, InfoPage.this.font, false, true));
                }
            }
            return ret;
        }
        ...
        protected void drawPanel(int entryRight, int relativeY, Tessellator tess, int mouseX, int mouseY) {
            ...
            for (ITextComponent line : this.lines) {
                if (line != null) {
                    ...
                    InfoPage.this.font.drawString(line.getFormattedText(), left + 4, relativeY, 0);
            ...
            if (line != null) {
                ...
                for (ITextComponent part : line) {
                    if (!(part instanceof StringTextComponent))
                        continue;
                    k += InfoPage.this.font.getStringWidth(((StringTextComponent) part).getText());
                    if (k >= mouseX) {
                        return part;
                    }
                }
        ...
        public boolean mouseClicked(final double mouseX, final double mouseY, final int button) {
            ...
            if (component != null) {
                InfoPage.this.handleComponentClicked(component);
                return true;
            }
    ...
    @Override
    public void init() {
        this.loreInfo = new InfoPage.InfoPanel(this.minecraft, 180, this.height - 60, 31);
        loreInfo.setInfo(this.font.listFormattedStringToWidth(this.lore.getFormattedText(), 175));
        children.add(loreInfo);
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        this.loreInfo.render(mouseX, mouseY, partialTicks);
