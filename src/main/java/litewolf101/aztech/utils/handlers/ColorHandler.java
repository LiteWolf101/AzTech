...
public class ColorHandler implements IBlockColor {
	...
	public static void init() {
		...
		itemColors.registerItemColorHandler((stack, tintIndex) -> blockColors.colorMultiplier(((ItemBlock)stack.getItem()).getBlock().getStateFromMeta(stack.getMetadata()), null, null, tintIndex), BlocksInit.ANCIENT_GRASS, BlocksInit.SHORT_GRASS);
	}
