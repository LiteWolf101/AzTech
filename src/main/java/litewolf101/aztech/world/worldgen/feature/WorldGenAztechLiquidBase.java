 ...
 */
public class WorldGenAztechLiquidBase {
    private final Block block;

    public WorldGenAztechLiquidBase(Block blockIn)
    {
        this.block = blockIn;
    }
                ...
                for (int j2 = 0; j2 < 16; ++j2)
                {
                    for (int k3 = 0; k3 < 16; ++k3)
                    {
                        for (int k4 = 0; k4 < 8; ++k4)
                        {
                            ...
                            {
                                worldIn.setBlockState(position.add(j2, k4, k3), BlocksInit.ANCIENT_ROCK.getDefaultState(), 2);
                            }
                        }
                    }
                }
