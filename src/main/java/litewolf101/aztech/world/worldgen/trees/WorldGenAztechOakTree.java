...
public class WorldGenAztechOakTree extends WorldGenAbstractTree {
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        if (position.getY() <= 13 && position.getY() + minTrunkHeight + 1 >= 128 || materialBelow != Material.GRASS && materialBelow != Material.GROUND || worldIn.provider.getDimension() != AzTechConfig.dimension_ID) {
            return false;
        } else {
