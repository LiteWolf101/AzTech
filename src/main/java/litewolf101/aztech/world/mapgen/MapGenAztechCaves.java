 ...
 */
public class MapGenAztechCaves extends MapGenBase {
                                ...
                                if (xDiff * xDiff + zDiff * zDiff < 1D)
                                    for (int py = maxY - 1; py >= minY; --py) {
                                        ...
                                        if (yDiff > -0.7D && xDiff * xDiff + yDiff * yDiff + zDiff * zDiff < 1D) {
                                            ...
                                            if (state.getBlock() == BlocksInit.ANCIENT_STONE || state.getBlock() == BlocksInit.ANCIENT_DIRT || state.getBlock() == BlocksInit.ANCIENT_GRASS)
