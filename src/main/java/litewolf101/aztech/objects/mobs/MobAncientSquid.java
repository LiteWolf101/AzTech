...
public class MobAncientSquid extends EntitySquid {
    ...
    public MobAncientSquid(World worldIn) {
        super(worldIn);
    ...
    {
        this.tasks.addTask(0, new MobAncientSquid.AIMoveRandom(this));
    }

    static class AIMoveRandom extends EntityAIBase
    {
        private final MobAncientSquid squid;

        public AIMoveRandom(MobAncientSquid p_i45859_1_)
        {
