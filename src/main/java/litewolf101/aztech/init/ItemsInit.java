...
import litewolf101.aztech.objects.armor.ArmourBase;
...
public class ItemsInit {
	...
	public static final ItemArmor.ArmorMaterial ARMOUR_YELLOW_RUNE = EnumHelper.addArmorMaterial("armour_yellow_rune", Reference.MODID + ":yellow_rune", 20, new int[] {
			3,
			6,
			7,
			3
	}, 11, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 1.7f);
	public static final ItemArmor.ArmorMaterial ARMOUR_GREEN_RUNE = EnumHelper.addArmorMaterial("armour_green_rune", Reference.MODID + ":green_rune", 20, new int[] {
			3,
			6,
			7,
			3
	}, 11, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 1.7f);
	public static final ItemArmor.ArmorMaterial ARMOUR_BLUE_RUNE = EnumHelper.addArmorMaterial("armour_blue_rune", Reference.MODID + ":blue_rune", 20, new int[] {
			3,
			6,
			7,
			3
	}, 11, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 1.7f);
	public static final ItemArmor.ArmorMaterial ARMOUR_WHITE_RUNE = EnumHelper.addArmorMaterial("armour_white_rune", Reference.MODID + ":white_rune", 20, new int[] {
			3,
			6,
			7,
			3
	}, 11, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 1.7f);
	public static final ItemArmor.ArmorMaterial ARMOUR_BLACK_RUNE = EnumHelper.addArmorMaterial("armour_back_rune", Reference.MODID + ":black_rune", 20, new int[] {
			3,
			6,
			7,
			3
	...
	//materials armor
	public static final ItemArmor.ArmorMaterial ARMOUR_RED_RUNE = EnumHelper.addArmorMaterial("armour_red_rune", Reference.MODID + ":red_rune", 20, new int[] {
			3,
			6,
			7,
			3
	}, 11, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 1.7f).setRepairItem(new ItemStack(ItemsInit.RED_RUNE_SHARD));
