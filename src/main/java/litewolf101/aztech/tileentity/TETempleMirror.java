        ...
        if (world.getBlockState(pos.offset(offsetLaserDirection)) == BlocksInit.LASER_BLOCK.getDefaultState().withProperty(AXIS, laserBlockAxis)) {
            for (int i = 1; i <= range; i++) {
                if (mirrorOffsetDirection == EnumFacing.NORTH || mirrorOffsetDirection == EnumFacing.SOUTH) {
                    if (world.getBlockState(pos.offset(mirrorOffsetDirection, i)) == BlocksInit.TEMPLE_MIRROR.getDefaultState().withProperty(AXIS, EnumFacing.Axis.Y).withProperty(FLIPPED, false).withProperty(INVERT_IO, true)||
                            world.getBlockState(pos.offset(mirrorOffsetDirection, i)) == BlocksInit.TEMPLE_MIRROR.getDefaultState().withProperty(AXIS, EnumFacing.Axis.Y).withProperty(FLIPPED, true).withProperty(INVERT_IO, true)||
                            world.getBlockState(pos.offset(mirrorOffsetDirection, i)) == BlocksInit.TEMPLE_MIRROR.getDefaultState().withProperty(AXIS, EnumFacing.Axis.Z).withProperty(FLIPPED, false).withProperty(INVERT_IO, true)||
                            world.getBlockState(pos.offset(mirrorOffsetDirection, i)) == BlocksInit.TEMPLE_MIRROR.getDefaultState().withProperty(AXIS, EnumFacing.Axis.Z).withProperty(FLIPPED, true).withProperty(INVERT_IO, true)) {
                        check = true;
                        range = 20;
                    }
                }
                if (mirrorOffsetDirection == EnumFacing.EAST || mirrorOffsetDirection == EnumFacing.WEST) {
                    if (world.getBlockState(pos.offset(mirrorOffsetDirection, i + 1)) == BlocksInit.TEMPLE_MIRROR.getDefaultState().withProperty(AXIS, EnumFacing.Axis.Y).withProperty(FLIPPED, false).withProperty(INVERT_IO, false)||
                            world.getBlockState(pos.offset(mirrorOffsetDirection, i + 1)) == BlocksInit.TEMPLE_MIRROR.getDefaultState().withProperty(AXIS, EnumFacing.Axis.Y).withProperty(FLIPPED, true).withProperty(INVERT_IO, false)||
                            world.getBlockState(pos.offset(mirrorOffsetDirection, i + 1)) == BlocksInit.TEMPLE_MIRROR.getDefaultState().withProperty(AXIS, EnumFacing.Axis.X).withProperty(FLIPPED, false).withProperty(INVERT_IO, true)||
                            world.getBlockState(pos.offset(mirrorOffsetDirection, i + 1)) == BlocksInit.TEMPLE_MIRROR.getDefaultState().withProperty(AXIS, EnumFacing.Axis.X).withProperty(FLIPPED, true).withProperty(INVERT_IO, true)) {
                        check = true;
                        range = 20;
                    }
                }
                if (mirrorOffsetDirection == EnumFacing.UP || mirrorOffsetDirection == EnumFacing.DOWN) {
                    if (world.getBlockState(pos.offset(mirrorOffsetDirection, i + 1)) == BlocksInit.TEMPLE_MIRROR.getDefaultState().withProperty(AXIS, EnumFacing.Axis.X).withProperty(FLIPPED, false).withProperty(INVERT_IO, false)||
                            world.getBlockState(pos.offset(mirrorOffsetDirection, i + 1)) == BlocksInit.TEMPLE_MIRROR.getDefaultState().withProperty(AXIS, EnumFacing.Axis.X).withProperty(FLIPPED, true).withProperty(INVERT_IO, false)||
                            world.getBlockState(pos.offset(mirrorOffsetDirection, i + 1)) == BlocksInit.TEMPLE_MIRROR.getDefaultState().withProperty(AXIS, EnumFacing.Axis.Z).withProperty(FLIPPED, false).withProperty(INVERT_IO, false)||
                            world.getBlockState(pos.offset(mirrorOffsetDirection, i + 1)) == BlocksInit.TEMPLE_MIRROR.getDefaultState().withProperty(AXIS, EnumFacing.Axis.Z).withProperty(FLIPPED, true).withProperty(INVERT_IO, false)) {
                        check = true;
                        range = 20;
                    }
                }
